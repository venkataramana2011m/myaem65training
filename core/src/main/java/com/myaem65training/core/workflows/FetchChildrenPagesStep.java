package com.myaem65training.core.workflows;
...
import static com.myaem65training.core.constants.AppConstants.EQUALS;
import static com.myaem65training.core.constants.AppConstants.PROCESS_LABEL;
import static com.myaem65training.core.workflows.FetchChildrenPagesStep.PROCESS_LABEL_VALUE;
import java.util.Iterator;
import java.util.Objects;

import static com.day.cq.wcm.api.NameConstants.NT_PAGE;
import static com.myaem65training.core.constants.AppConstants.CHILD_PAGE_COUNT;
@Component(
        service = WorkflowProcess.class,
        property = { PROCESS_LABEL + EQUALS + PROCESS_LABEL_VALUE }
)
