(function() {
    ...
    angular.module('HiggidyCarousel', []).controller('HiggidyCarousel.controller', function($scope, $interval) {
            var timeout;
            $scope.carousel = {
                current: 0,
                max: 0
                ...
                link: {
                    post: function(scope, element) {
                        ...
                        scope.animateScroll = function() {
                            element.css({
                                'margin-left': 0 - scope.carousel.width * scope.carousel.current + "px"
                            });
                        };
